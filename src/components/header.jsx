...
function Header(){
    ...
    return(
        <div className="absolute inset-0 h-12" >
            ...
            :
            <div className="flex flex-col h-[185px] bg-[#00EF75] " >
                <div className="flex justify-end" >
                ...
                <div className="flex flex-col justify-center " >
                    <div className="text-4xl text-left px-4 font-bold font-white cursor-pointer">settings</div>
                    <div className="text-4xl text-left px-4 font-bold font-white cursor-pointer">about</div>
                    <div className="text-4xl text-left px-4 font-bold font-white cursor-pointer">tutorial</div>
                </div>
            </div>
            }
        </div>
